...
connectionstr = "HostName=numbiot-prod-iothub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=is9zn4dqbDjYtTl6S+spPiCgtWCMbPrl8jtO2ogVttY=" # Replace this with the Primary Connection String for your IoT device myPi
device = 'myPi'
